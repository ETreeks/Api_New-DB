...
namespace ETreeks.Infra.Repository
{
    public class ReservationRepository : IReservationRepository
    {
        ...
        public async Task<int> CreateReservation(Reservation reservation)
        {
            ...
            param.Add("Session_Id", reservation.Session_Id, DbType.Decimal, direction: ParameterDirection.Input);
        ...
        public async Task<List<ReservationDate2>> GetAllReservations()
        {
            var result = await _dbContext.Connection.QueryAsync<ReservationDate2>("Reservation_Pkg.GET_ALL_RESERVATIONS", commandType: CommandType.StoredProcedure);
            return result.ToList();
        }

        public async Task<List<ReservationDate4>> GetAllReservations4()
        {
            var result = await _dbContext.Connection.QueryAsync<ReservationDate4>("Reservation_Pkg.GET_ALL_RESERVATIONS2", commandType: CommandType.StoredProcedure);
            return result.ToList();
        }
        ...
        public async Task UpdateReservation(Reservation reservation)
        {
            ...
            parameters.Add("new_Session_Id", reservation.Session_Id, DbType.Int32, ParameterDirection.Input);
