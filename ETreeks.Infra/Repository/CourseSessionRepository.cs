...
namespace ETreeks.Infra.Repository
{
	...
	public class CourseSessionRepository : ICourseSessionRepository
	{
		...
		public async Task<int> CreateCourseSession(CourseSession courseSession)
		{
			...
			param.Add("Available_Status", courseSession.Available_Status, dbType: DbType.String, direction: ParameterDirection.Input);
			param.Add("Course_ID", courseSession.Course_Id, dbType: DbType.Decimal, direction: ParameterDirection.Input);
		...
		public async Task<int> UpdateCourseSession(CourseSession courseSession)
		{
			...
			param.Add("new_Available_Status", courseSession.Available_Status, dbType: DbType.String, direction: ParameterDirection.Input);
			param.Add("new_Course_ID", courseSession.Course_Id, dbType: DbType.Decimal, direction: ParameterDirection.Input);
