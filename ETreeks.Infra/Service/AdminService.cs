...
namespace ETreeks.Infra.Service
{
    public class AdminService : IAdminService
    {
        ...
        public AdminService(IAdminRepository adminRepository , IEmailService service)
        {
        ...
        public async Task<List<ReservationDate2>> GetAllReservation2()
        {
            return await _adminRepository.GetAllReservation2();
        }
        ...
        {
            return await _adminRepository.GetAllPendingTrainer2();
        }
