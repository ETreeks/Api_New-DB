...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseOracle("User Id=C##ET;PASSWORD=Test321;DATA SOURCE=localhost:1521/xe");
            }
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.HasDefaultSchema("C##ET")
            ...
            modelBuilder.Entity<Contactu>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email1, "SYS_C009101")
                    .IsUnique();

                entity.HasIndex(e => e.Email2, "SYS_C009102")
                    .IsUnique();
            ...
            modelBuilder.Entity<CourseSession>(entity =>
            {
                ...
                entity.Property(e => e.Available_Status)
                    .HasMaxLength(20)
                    .IsUnicode(false)
            ...
            modelBuilder.Entity<Guser>(entity =>
            {
                ...
                entity.HasIndex(e => e.Username, "SYS_C009106")
                    .IsUnique();

                entity.HasIndex(e => e.Email, "SYS_C009107")
                    .IsUnique();
                ...
                entity.Property(e => e.Bio_Trainer)
                    .HasMaxLength(400)
                    .IsUnicode(false)
            ...
            modelBuilder.Entity<Notification>(entity =>
            {
                ...
                entity.HasOne(d => d.Reservation)
                    ...
                    .HasConstraintName("FK_NOTIFICATION_RESERVATION");
