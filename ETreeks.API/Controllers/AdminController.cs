...
namespace ETreeks.API.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("GetAllReservation2")]
        public async Task<List<ReservationDate2>> GetAllReservation2()
        {
            return await _adminService.GetAllReservation2();
        }
        ...
        public Guser UploadIMage()
        {
            ...
            var fullPath = Path.Combine("C:\\Users\\Acer\\AngularFinalPro\\ETreeks_New_DB\\src\\assets\\Images", fileName);
